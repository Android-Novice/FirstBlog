...
from www.handlers import index, COOKIE_NAME, cookie2user
...
def init(loop):
    ...
    app = aiohttp.web.Application(loop=loop, middlewares=[logger_factory, auth_factory, response_factory])
